...
namespace lsmf
{
    ...
    public:
        ...
        void ChangeState(TileStateBase* newState);
    ...
    private:
        ...
        TileStateBase* m_CurrentState{ nullptr };
        // Declare state classes as friends
        friend class ExitState;
        friend class CrateState;
        friend class WallState;
        friend class EmptyState;
        friend class BombState;
        friend class PowerUpState;
